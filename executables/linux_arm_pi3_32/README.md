# VividGo2 - Raspberry Pi 3/4/5 (32-bit OS)

**Platform:** Linux ARMv7 (32-bit) - Raspberry Pi 3, 4, or 5 running 32-bit OS
**File:** `vividgo2`

## System Requirements

- Raspberry Pi 3 (Model B/B+), Pi 4, or Pi 5
- Raspberry Pi OS (32-bit) or any ARMv7-compatible Linux distribution

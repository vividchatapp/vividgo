#!/bin/bash
# VividGo background launcher for Linux/Unix-like systems.
# This script intentionally starts the bot in the background so it keeps running
# even after the terminal is closed or the SSH session ends.
# Use this when you want the bot to continue running as a detached service.
